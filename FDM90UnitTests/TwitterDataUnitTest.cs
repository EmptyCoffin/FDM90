...
namespace FDM90UnitTests
{
    ...
    public class TwitterDataUnitTest
    {
        ...
        {
            return "{\"NumberOfFollowers\":50,\"Tweets\":[{\"CreatedAt\":\"" + DateTime.Now.ToString("s") + "+0000" + "\",\"ScreenName\":null,\"FavoriteCount\":3,\"RetweetCount\":6,\"StatusID\":1254987456,\"Text\":\"This Is Test Tweet 1\",\"ImageUrl\":null,\"Retweeted\":true,\"Favorited\":true,\"RetweetedUsers\":[{\"NumberOfFollowers\":181},{\"NumberOfFollowers\":143},{\"NumberOfFollowers\":405},{\"NumberOfFollowers\":166},{\"NumberOfFollowers\":448},{\"NumberOfFollowers\":493}]},{\"CreatedAt\":\"" + DateTime.Now.AddDays(-2).ToString("s") + "+0000" + "\",\"ScreenName\":null,\"FavoriteCount\":8,\"RetweetCount\":16,\"StatusID\":546158431,\"Text\":\"This Is Test Tweet 2\",\"ImageUrl\":\"TestUrl\",\"Retweeted\":true,\"Favorited\":true,\"RetweetedUsers\":[{\"NumberOfFollowers\":181},{\"NumberOfFollowers\":143},{\"NumberOfFollowers\":405},{\"NumberOfFollowers\":166},{\"NumberOfFollowers\":448},{\"NumberOfFollowers\":493},{\"NumberOfFollowers\":25},{\"NumberOfFollowers\":235},{\"NumberOfFollowers\":257},{\"NumberOfFollowers\":241},{\"NumberOfFollowers\":342},{\"NumberOfFollowers\":32},{\"NumberOfFollowers\":2},{\"NumberOfFollowers\":422},{\"NumberOfFollowers\":110},{\"NumberOfFollowers\":215}]},{\"CreatedAt\":\"" + DateTime.Now.AddDays(-1).ToString("s") + "+0000" + "\",\"ScreenName\":null,\"FavoriteCount\":1,\"RetweetCount\":2,\"StatusID\":549845579112,\"Text\":\"This Is Test Tweet 3\",\"ImageUrl\":\"TestUrl2\",\"Retweeted\":true,\"Favorited\":true,\"RetweetedUsers\":[{\"NumberOfFollowers\":181},{\"NumberOfFollowers\":143}]},{\"CreatedAt\":\"" + DateTime.Now.AddDays(-5).ToString("s") + "+0000" + "\",\"ScreenName\":null,\"FavoriteCount\":8,\"RetweetCount\":8,\"StatusID\":32154578612,\"Text\":\"This Is Test Tweet 4\",\"ImageUrl\":null,\"Retweeted\":true,\"Favorited\":true,\"RetweetedUsers\":[{\"NumberOfFollowers\":181},{\"NumberOfFollowers\":143},{\"NumberOfFollowers\":405},{\"NumberOfFollowers\":166},{\"NumberOfFollowers\":448},{\"NumberOfFollowers\":493},{\"NumberOfFollowers\":25},{\"NumberOfFollowers\":235}]}], \"NumberOfFollowersByDate\":{\"" + DateTime.Now.AddDays(-1).ToString("s") + "+0000" + "\":15,\"" + DateTime.Now.ToString("s") + "+0000" + "\":7,\"" + DateTime.Now.AddDays(-5).ToString("s") + "+0000" + "\":4,\"" + DateTime.Now.AddDays(-3).ToString("s") + "+0000" + "\":120}}";
        }
    }
}
